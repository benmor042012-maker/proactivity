...
'c.takephoto':   ('צלם', 'Take photo', 'Photo', 'Снять', 'التقاط'),
'c.choosephoto': ('בחר תמונה', 'Choose photo', 'Choisir une photo', 'Выбрать фото', 'اختر صورة'),
...
'l.pr.cta':      ('התחל ניסיון', 'Start trial', 'Commencer l\'essai', 'Начать пробный период', 'ابدأ التجربة'),
...
'l.faq.a1':      ('אתה בוחר: 15, 30 או 45 דקות. התוכנית נבנית סביב מה שאמרת, לא סביב מה שנוח לנו.',
                  ...
                  'أنت تختار: 15 أو 30 أو 45 دقيقة. تُبنى الخطة حول ما قلته، لا حول ما يناسبنا.'),
